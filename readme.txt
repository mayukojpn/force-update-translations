...
Please report security bugs found in the source code of the Force Update Translations plugin through the [Patchstack Vulnerability Disclosure Program](https://patchstack.com/database/vdp/96fd2d66-54a9-4344-8c9e-eff7f209f90c). The Patchstack team will assist you with verification, CVE assignment, and notify the developers of this plugin.
